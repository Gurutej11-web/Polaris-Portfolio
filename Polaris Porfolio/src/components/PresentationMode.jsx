...
const slides = [
  ...
  },
  {
    ...
    kicker: 'People + Process',
    detail: 'We run short weekly sprints with clear goals, quick standups, and shared checklists across subteams.',
    detail2: 'Pairing new members with experienced leads accelerates learning and keeps standards consistent.',
    detail3: 'Every meeting ends with action items and owners to keep momentum strong.',
    humanNote: 'We value kindness, accountability, and celebrating progress together.',
    callout: 'Key takeaway: Consistent cadence and communication keep our team aligned.',
    tags: ['Cadence', 'Mentorship', 'Accountability'],
    stats: [
      { label: 'Weekly syncs', value: '2' },
      { label: 'Leads', value: '4' },
      { label: 'Mentor check-ins', value: 'Weekly' },
    ],
    accent: '#38BDF8',
    chart: {
      ...
      items: [
        ...
        { label: 'Ownership', value: 86 },
        { label: 'Collaboration', value: 90 },
      ],
    },
    image: '/team/DSC_1126.JPG',
    imageAlt: 'Team members collaborating during a meeting',
  },
  {
    title: 'Team Growth',
    subtitle: 'Building leaders and specialists',
    kicker: 'Student Development',
    detail: 'We develop technical depth through mentorship, documentation, and rotating leadership roles.',
    detail2: 'Members rotate between design, build, and software tasks to build cross-team understanding.',
    detail3: 'This approach creates resilient teams that can adapt quickly during competition.',
    humanNote: 'Our goal is to leave every member more confident and capable than when they started.',
    callout: 'Key takeaway: Skill growth is as important as competitive results.',
    tags: ['Leadership', 'Skill-building', 'Growth'],
    stats: [
      { label: 'Members trained', value: '10' },
    ...
    image: '/team/DSC_1096.JPG',
    imageAlt: 'Team members learning and building together',
  },
  {
